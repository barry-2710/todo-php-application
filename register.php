    ...
    <body>
        ...
        <div class="card text center container col-6 mt-5 mb-4" id="login">
            <div class="card-body" id="login_content">
                ...
                <input type="date" placeholder="Date" id="birthday" class="form-control textbox-n" name="birthday" onfocus="(this.type='date')" onblur="(this.type='text')">
                

                <!-- Sign up button -->
                <button class="btn btn-dark btn-block my-4" type="submit" style="border-radius:20px;">Register</button>
